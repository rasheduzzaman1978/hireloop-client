      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
          ...
          {jobs.map((job) => (
            ...
            <div
              key={job.id}
              className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition duration-300 hover:border-indigo-300 hover:shadow-xl dark:border-white/5 dark:bg-[#0B0B0F] dark:hover:border-white/10 dark:hover:bg-[#101015]"
            >
              ...
              <p className="mt-4 text-sm leading-7 text-gray-600 dark:text-zinc-500">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2 rounded-full border border-gray-200 bg-gray-100 px-3 py-2 text-xs text-gray-700 dark:border-white/5 dark:bg-white/[0.03] dark:text-zinc-300">
              ...
              <button className="mt-10 flex items-center gap-2 text-sm font-medium text-gray-900 transition hover:text-indigo-500 dark:text-white dark:hover:text-indigo-400">
        ...
        <div className="mt-14 flex justify-center">
          ...
          <div className="relative w-fit overflow-hidden rounded-3xl p-[2px]">
            ...
            <button className="relative rounded-3xl bg-white px-4 py-3 text-sm font-medium text-gray-900 transition hover:bg-gray-100 dark:bg-black dark:text-white dark:hover:bg-[#101015]">
